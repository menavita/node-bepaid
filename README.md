...
bepaid.createErip({
	amount: amount, description: 'description', order_id 'order_id', permanent: (true/false), account_number: 'account_number', service_no: 'service_no', email: 'email', notification_url: 'url'}).then(function(res){ console.log(JSON.parse(res)); });
